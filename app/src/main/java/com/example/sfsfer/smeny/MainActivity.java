package com.example.sfsfer.smeny;
...
public class MainActivity extends AppCompatActivity{
    ...
    final String[] sviatky = {"0101","0106","0414","0417","0501","0508","0705","0829","0901","0915","1101","1117","1224","1225","1226"};
    int nSmena;
    AnimatorSet popup;
    @Override
    ...
    private void Refresh(){
        ...
        for(int i = 1; i < 43; i++){
            ...
            if(Arrays.asList(sviatky).contains(name.substring(4))){
                isSviatok = true;
            }
